...
class UserIO {
  ...
  Command setBackLedIntensity(int i) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x01, i],
        ),
      );
  Command setMainLedBlueIntensity(int b) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x08, b],
        ),
      );
  Command setMainLedColor(int r, int g, int b) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x70, r, g, b],
        ),
      );
  Command setMainLedGreenIntensity(int g) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x04, g],
        ),
      );
  Command setMainLedRedIntensity(int r) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x02, r],
        ),
      );
  Command playAudioFile(int idx) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.playAudioFile,
          payload: [idx, 0x00, 0x00],
        ),
      );
  Command turnDome(Uint8List angle) => _encodeAnimatronics(
        CommandPartial(
          commandId: AnimatronicsCommandIds.domePosition,
          payload: [angle[1], angle[0], 0x00, 0x00],
        ),
      );
  Command setStance(int stance) => _encodeAnimatronics(
        CommandPartial(
          commandId: AnimatronicsCommandIds.shoulderAction,
          payload: [stance],
        ),
      );
  Command playAnimation(int animation) => _encodeAnimatronics(
        CommandPartial(
  ...
  Command setR2D2LEDColor(int r, int g, int b) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
  ...
  Command setR2D2FrontLEDColor(int r, int g, int b) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
  ...
  /// (each can range between 0 and 255)
  Command setR2D2BackLEDcolor(int r, int g, int b) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x70, r, g, b],
        ),
  ...
  Command setR2D2HoloProjectorIntensity(int i) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x80, i],
        ),
  ...
  Command setR2D2LogicDisplaysIntensity(int i) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.allLEDs,
          payload: [0x00, 0x08, i],
        ),
  ...
  Command setR2D2Waddle(int waddle) => _encodeAnimatronics(
        CommandPartial(
          commandId: AnimatronicsCommandIds.shoulderAction,
          payload: [waddle],
        ),
      );
  Command playR2D2Sound(int hex1, int hex2) => _encode(
        CommandPartial(
          commandId: UserIOCommandIds.playAudioFile,
