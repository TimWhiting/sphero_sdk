...
class AdaptorV1BLE extends AdaptorV1 {
  ...
  ble.Characteristic _antiDosChar;
  ble.Characteristic _wakeChar;
  ble.Characteristic _txChar;
  ble.Characteristic _commandChar;
  ble.Characteristic _responseChar;
  ...
  @override
  Future<void> write(Uint8List data) => _commandChar.write(data, true);
...
#########################################''',
  ...
  Future<void> wake() => _wakeChar.write(Uint8List.fromList([1]), true);
  // writeServiceCharacteristic(
  //  BLEService, WakeCharacteristic, Uint8List.fromList([1]), false);

  Future<void> setTXPower(int level) =>
      _txChar.write(Uint8List.fromList([level]), true);
  //writeServiceCharacteristic(
  ...
  Future<void> setAntiDos() {
    ...
    return _antiDosChar.write(bytes, true); //writeServiceCharacteristic(
