  ...
  '2:36': const APIV1(
    ...
    fields: [
      APIField(
        ...
        type: 'predefined',
        mask: 0x01,
        values: <int, bool>{0x00: false, 0x01: true},
      ),
      APIField(
        name: 'vectorDrive',
        type: 'predefined',
        mask: 0x02,
        values: <int, bool>{0x00: false, 0x02: true},
      ),
      APIField(
        name: 'selfLevelOnCharger',
        type: 'predefined',
        mask: 0x04,
        values: <int, bool>{0x00: false, 0x04: true},
      ),
      APIField(
        name: 'tailLedAlwaysOn',
        type: 'predefined',
        mask: 0x08,
        values: <int, bool>{0x00: false, 0x08: true},
      ),
      APIField(
        name: 'motionTimeouts',
        type: 'predefined',
      ...
      APIField(
        ...
        type: 'predefined',
        mask: 0x80,
        values: <int, bool>{0x00: false, 0x80: true},
      ),
      APIField(
        name: 'gyroMaxAsyncMsg',
        type: 'predefined',
        mask: 0x100,
        values: <int, bool>{0x00: false, 0x100: true},
      )
    ],
  ),
  '2:38': const APIV1(
